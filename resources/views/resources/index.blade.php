        ...
        <div class="grid grid-cols-1 gap-4 sm:px-6 lg:px-8">
            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800 dark:text-white/70 dark:ring-zinc-700">
                ...
                <div class="pt-3 sm:pt-5 w-full">
                    <a href="{{route('services.resources.create', $service->id)}}?type=Handouts" class="float-right bg-black text-white dark:bg-white dark:text-black px-2 rounded-full font-bold">
                        +
                    </a>
                    <h2 class="text-xl font-semibold text-black dark:text-white">Handouts</h2>
